...
- Cajitas (Espacios en memoria) donde podemos guardar informacion
(dependiendo de los tipos y estructuras de datos que soporte nuestro lenguaje)

### ¿Cuál es la diferencia entre declarar e inicializar una variable?

-Declarar es cuando le decimos a JAvaScript que vamos a crear una variable con
el nombre tal. Mientras que inicializar (o reinicializar) es asognarle un valor a esa variable.
